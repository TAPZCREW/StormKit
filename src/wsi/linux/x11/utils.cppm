...
namespace stormkit::wsi::linux::x11 {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    inline auto screen_of_display(xcb_connection_t* c, int screen) noexcept -> xcb_screen_t* {
        auto iter = xcb_screen_iterator_t {};

        for (iter = xcb_setup_roots_iterator(xcb_get_setup(c)); iter.rem; --screen, xcb_screen_next(&iter))
    ...
    inline auto default_root_window(xcb_connection_t* connection, int32_t screen_id) noexcept -> xcb_window_t {
    ...
    /////////////////////////////////////
    STORMKIT_CONST
    inline auto x11_key_to_char(xcb_keysym_t key) noexcept -> char {
        switch (key) {
