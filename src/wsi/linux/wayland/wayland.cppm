...
export namespace stormkit::wsi::linux::wayland::wl {
    using Display  = stormkit::RAIICapsule<wl_display*, wl_display_connect, wl_display_disconnect, struct DisplayTag, nullptr>;
    using Registry = stormkit::
      RAIICapsule<wl_registry*, wl_display_get_registry, wl_registry_destroy, struct RegistryTag, nullptr>;
    ...
    using ShmPool     = stormkit::RAIICapsule<wl_shm_pool*, wl_shm_create_pool, wl_shm_pool_destroy, struct ShmPoolTag, nullptr>;
    using CursorTheme = stormkit::
      RAIICapsule<wl_cursor_theme*, wl_cursor_theme_load, wl_cursor_theme_destroy, struct CursorThemeTag, nullptr>;
