...
namespace stormkit::gpu {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto Device::doInit(const Instance& instance, const Info& info) -> Expected<void> {
    ...
    Device::~Device() {
        if (m_vk_handle) [[likely]] {
            waitIdle();
            vkCall(ivkDestroyDevice, m_vk_handle)
                .or_else(core::monadic::assert("Failed to destroy vulkan device"));
        }
    }
