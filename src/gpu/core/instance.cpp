...
namespace stormkit::gpu {
    ...
    namespace {
        ...
        constexpr auto STORMKIT_VK_VERSION = vk_make_version<Int32>(STORMKIT_MAJOR_VERSION,
    ...
    auto Instance::do_init() noexcept -> Expected<void> {
        return vk_enumerate<VkExtensionProperties>(vkEnumerateInstanceExtensionProperties, nullptr)
          .and_then([this](auto&& exts) noexcept {
              m_extensions = exts
                             | std::views::transform([](auto&& extension) static noexcept {
              ...
              const auto app_info = VkApplicationInfo {
                  ...
                  .applicationVersion = vk_make_version<Int32>(0, 0, 0),
                  .pEngineName        = ENGINE_NAME,
                  .engineVersion      = STORMKIT_VK_VERSION,
                  .apiVersion         = vk_make_version<Int32>(1, 4, 0),
              };
              ...
              const auto create_info = VkInstanceCreateInfo {
                  ...
                  .enabledLayerCount       = as<UInt32>(std::ranges::size(validation_layers)),
                  .ppEnabledLayerNames     = std::ranges::data(validation_layers),
                  .enabledExtensionCount   = as<UInt32>(std::ranges::size(instance_extensions)),
    ...
    auto Instance::do_init_debug_report_callback() noexcept -> VulkanExpected<void> {
        ...
        return vk_call<VkDebugUtilsMessengerEXT>(vkCreateDebugUtilsMessengerEXT,
          ...
          .transform([] static noexcept { ilog("Validation layers successfully enabled !"); });
    }
