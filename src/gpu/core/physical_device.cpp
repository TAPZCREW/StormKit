...
namespace stormkit::gpu {
    namespace {
        ...
        /////////////////////////////////////
        /////////////////////////////////////
        auto vendor_name_by_id(UInt64 ID) -> std::string_view {
            switch (ID) {
    ...
    /////////////////////////////////////
    /////////////////////////////////////
    auto score_physical_device(const PhysicalDevice& physical_device) noexcept -> UInt64 {
    ...
    PhysicalDevice::PhysicalDevice(VkPhysicalDevice physical_device) noexcept
        ...
        m_device_info.type = from_vkflags<PhysicalDeviceType>(properties.deviceType);
        ...
        m_capabilities.features.draw_indirect_first_instance = features.draw_indirectFirstInstance;
