...
#define EQUAL_FUNC(x)                                                                       \
    ...
    struct std::equal_to<x> {                                                               \
        [[nodiscard]]                                                                       \
        constexpr auto operator()(const x& first, const x& second) const noexcept -> bool { \
...
#define CONSTRAINED_EQUAL_FUNC(x)                                                           \
    ...
    struct std::equal_to<T> {                                                               \
        [[nodiscard]]                                                                       \
        constexpr auto operator()(const T& first, const T& second) const noexcept -> bool { \
...
#define TEMPLATED_EQUAL_FUNC(x, z, y)                                                             \
    ...
    struct std::equal_to<x<y>> {                                                                  \
        [[nodiscard]]                                                                             \
        constexpr auto operator()(const x<y>& first, const x<y>& second) const noexcept -> bool { \
