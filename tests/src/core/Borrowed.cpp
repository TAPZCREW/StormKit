...
namespace {
    auto _ = test::TestSuite { "Core.Borrowed",
                               {
                                   { "borrows<std::vector>.all_ref",
                                     [] static noexcept {
                                         auto a = 0;
                                         auto b = 1;
                                         auto c = 2;
